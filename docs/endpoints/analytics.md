...
| Endpoint | Servicio |
|---|---|
| `GET /summary` | [get_summary](../../app/services/analytics_service.py) — total de comprobantes, monto total, IGV total, cuántos están con detalle SUNAT vs. pendientes de extracción. |
