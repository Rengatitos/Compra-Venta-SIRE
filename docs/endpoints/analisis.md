...
## `POST /api/v1/empresas/{ruc}/periodos/{periodo}/analisis`

[ejecutar_analisis](../../app/api/v1/routes/analisis.py:20). Clasifica contablemente, con Gemini, todos los comprobantes del periodo que estén pendientes de análisis (ver [modelo de datos — estado_procesamiento](../modelo-datos/comprobantes.md)). Límite: 5/minuto.
