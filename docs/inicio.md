...
| MONGO_FACTURASDB_NAME | str, opcional en el schema pero requerida en la práctica | Sí | Nombre de la base con las colecciones `empresas`, `periodos`, `comprobantes`, `jobs`. |
