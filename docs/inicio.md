...
| OLLAMA_EMBED_MODEL | str | No | Modelo local para embeddings; default `nomic-embed-text`. |
| RAG_MAX_CONCURRENCY | int | No | Máximo de comprobantes recuperados simultáneamente. |
| RAG_TOP_K_ACCOUNTS / RAG_TOP_K_HISTORICAL | int | No | Cuotas de recuperación local. |
