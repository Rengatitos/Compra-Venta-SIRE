...
[build_match_filter](../../app/services/analytics_service.py:29) construye el filtro común (empresas, periodo y `libro`) que reutilizan las distintas funciones de agregación: [get_summary](../../app/services/analytics_service.py:56), [get_top_contrapartes](../../app/services/analytics_service.py:105), [get_comprobantes_by_day](../../app/services/analytics_service.py:154) y [get_comprobantes_list](../../app/services/analytics_service.py:168). Los montos que devuelven estas agregaciones se convierten de `Decimal128` a `float` con [monto_a_float](../../app/repositories/_mongo.py:32), porque `Decimal128` no es serializable a JSON.
